    ...
    return (
        <>
            <div className={combineClasses(classes.featured_article,
                'md:border-l-[5px] border-b-[5px] md:border-b-0 border-slate-500 dark:bg-slate-800 dark:text-white dark:drop-shadow-lg cursor-pointer')}>
                <div className={'w-full md:w-[100%] lg:px-[40px] px-[15px] lg:py-[30px] py-[20px]'}>
                    ...
                    <p className={combineClasses(classes.featured_article__intro, "text-[16px] font-regular mt-0 mb-[10px]")}>
                        {article.shortIntro.slice(0, 150)} ...
                    </p>
                    {/* <ArticleTags tags={article.tags} /> */}
                    <p className={combineClasses(classes.featured_article__date, "font-normal text-sm pt-3 mb-0")}>{article.date + " - " + article.author.name}</p>
                </div>
